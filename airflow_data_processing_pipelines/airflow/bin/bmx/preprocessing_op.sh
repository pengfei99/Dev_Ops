...
#step 1. bmx_preprocessing, $1 is the project directory, $2 is the sample name, $3 is conf file, $4
conf_path=$3
sample_name=$2
project_dir=$1
...
sh /mnt/gpfs/pt6/airflow/bin/bmx/bmx_preproc.sh -c $conf_path -i $read_1 -I $read_2 -o $output
